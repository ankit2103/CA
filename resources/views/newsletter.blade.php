...
<html>
  ...
  <body>
          ...
          <ul class="navbar-nav ml-auto py-4 py-md-0">
            ...
            <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li class="dropdown-submenu ">
                  <a class="dropdown-item dropdown1 dropleft" href="#">Auditing & Assurance Services</a>
                  <ul class="dropdown-menu">
                ...
                <li class="dropdown-submenu">
                  <a class="dropdown-item dropdown1" href="#">Corperates Services</a>
                  <ul class="dropdown-menu">
    ...
    <!--------------End Of Navbar-------------><br><br>
    <h1 align="center">NEWS LETTER____</b></h1>
    <div class="container-fluid" align="center">
      @foreach ($users as $user)
        <div class="col-sm-6 abc" align="center">
          <div class="">
            <h5 align="left" style="padding-top: 10px;padding-left: 10px;"><b>User{{$user->title}}</b></h5>
            <p  align="left" style="padding-left: 20px;">{{$user->description}}</p><br>
          </div>
        </div><br>
      @endforeach
    </div>
