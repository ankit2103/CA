@php 
$users = DB::select('SELECT * FROM newsletter ORDER BY id DESC');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div align="center" class="container-fluid">
          <h2>News Letter<b style="color: blue">&nbsp;Post</b></h2>
          <form action="/newsletter_post" method="post" enctype="multipart/form-data">@csrf
            <div class="form__group field col-sm-6">
              <input type="text" class="form__field" placeholder="Tittle" name="title" id='name' required />
              <label for="name" class="form__label">News Tittle</label>
            </div>
            <div class="form__group field col-sm-6">
              <textarea  class="form__field"placholder="Description" name="description" > </textarea>
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <form action="/edit_newsletter_post/{{ $user->id }}" method="post" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
                      <div class="form__group field">
                        <input type="text" class="form__field" placeholder="Blog Name" name="title" id='name' required />
                        <label for="name" class="form__label">News Tittle</label>
                      </div>
                      <div class="form__group field">
                        <textarea class="form__field"placholder="Description" name="description" required> </textarea>
                        <label for="name" class="form__label">Description</label>
                      </div>
                      <br><br>
                    </div>
