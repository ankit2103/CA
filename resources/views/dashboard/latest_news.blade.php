@php 
$users = DB::select('SELECT * FROM news  ORDER BY id DESC   ');
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div align="center" class="container-fluid">
          <h2>Latest<b style="color: blue">&nbsp;News__</b></h2>
          <form action="/news_post" method="post" enctype="multipart/form-data">@csrf
            <div class="form__group field col-sm-6">
              <input type="text" class="form__field" placeholder="Blog Name" name="news_title" id='name' required />
              <label for="name" class="form__label">News Tittle</label>
            </div>
            <div class="form__group field col-sm-6">
              <textarea  class="form__field"placholder="Description" name="news_description" > </textarea>
          ...
          <tr>
            ...
            <td>{{ $user->date }}</td>
            <td><a href="/edit" data-toggle="modal" data-target="#exampleModalCenter">Edit </a><a style="padding-left: 20px;" href="/delete_latestnews/{{ $user->id }}">Delete</a>
            </tr>
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <form action="/edit_news/{{ $user->id }}" method="post" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
                      ...
                      <div class="form__group field ">
                        <label for="name" class="form__label">Last Date:-&nbsp;<input type="date" placeholder="Last Dtae" name="date" id='name' required /></label>
                      </div>
                      <br><br>
                    </div>
